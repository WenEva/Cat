! function(t) {
	...
	var k = function(t) {
		...
		return r(e, t), Object.defineProperty(e.prototype, "blocks", {
			...
			set: function(t) {
				switch (t) {
					case i.PLAYING:
						break;
					case i.LOSE:
						this.setStatusText(f.default("小可爱已经跑到地图边缘了，你输了"));
						break;
					case i.WIN:
						this.setStatusText(f.default("小可爱已经无路可走，你赢了"));
						break;
					default:
						return
				}
			...
			this.createAnimations(), this.createBlocks(), this.createCat(), this.createStatusText(), this.createResetButton(),
				this.createCreditText(), this.reset(), this.game.solver && (this.cat.solver = this.game.solver)
			...
			if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default(
				"游戏已经结束，重新开局")), this.reset(), !1;
			var n = this.getBlock(t, e);
			return n ? n.isWall ? (this.setStatusText(f.default("点击位置已经是墙了，禁止点击")), !1) : this.cat.i === t && this.cat.j ===
				e ? (this.setStatusText(f.default("点击位置是猫当前位置，禁止点击")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(
					f.default("猫已经无路可走，你赢了")), this.state = i.WIN, !1) : (this.setStatusText(f.default("您点击了 ") + "(" + t + ", " +
					e + ")"), this.cat.step() || (this.setStatusText(f.default("猫认输，你赢了！")), this.state = i.WIN), !0)) : (this.setStatusText(
					f.default("代码错误，当前位置不存在")), !1)
		}, e.prototype.reset = function() {
			this.cat.reset(), this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default(
				"点击小圆点，围住小猫"))
	...
	var i = n(0),
		...
		l = function(t) {
			...
			return r(e, t), Object.defineProperty(e.prototype, "i", {
				...
				0 === this.j || this.j === this.scene.h - 1 ? this.runForward() : 0 === this.i ? this.runDirection(0) : this.i ===
					this.scene.w - 1 && this.runDirection(3)
				...
				return null !== n && (!n.isWall && (this.play(s.default.directions[this.direction].name + "_step"), this.once(
					"animationcomplete",
					function() {
	...
	var i = n(2),
		s = function(t) {
			function e(e) {
				var n = t.call(this, e, 0, 0, i.default("重来一句"), {}) || this;
				n.setColor("#000000");
				var o = e.r;
	...
	var i = function(t) {
		function e(e) {
			...
			n.setColor("#000000");
			var o = e.r;
			return n.setFontSize(o), "center" === e.game.myConfig.statusBarAlign && (n.setX(e.game.canvas.width / 2), n.setOrigin(
				.5, 0)), n.setPadding(o, o, o, o), n
		}
		return r(e, t), e
	}(Phaser.GameObjects.Text);
	e.default = i
	...
	var o = n(0),
		r = function() {
			function t(t, e, n, o) {
				this.i = e, this.j = n, this.isWall = o, this.distance = 1 / 0, this.parent = t, this.isEdge = this.i <= 0 ||
					this.i >= this.parent.w - 1 || this.j <= 0 || this.j >= this.parent.h - 1
			}
			...
			return t.prototype.getBlock = function(t, e) {
				...
				for (var e = function() {
						...
						e.neighbours.forEach(function(n) {
							null === n || n.isEdge || n.isWall || n.distance > e.distance + 1 && (n.distance = e.distance + 1, t.indexOf(
								n) < 0 && t.push(n))
						})
					}; t.length > 0;) e()
	...
	var i = n(28),
		s = function(t) {
			...
			return r(e, t), e.prototype.load = function() {
				this.state === Phaser.Loader.FILE_POPULATED ? this.loader.nextFile(this, !0) : this.xhrLoader = i.default(this,
					this.loader.xhr)
			}, e
	...
	e.default = function(t, e) {
		var n = new o.default;
		return n.open("GET", t.src, e.async, e.user, e.password), n.responseType = t.xhrSettings.responseType, n.timeout =
			e.timeout, e.header && e.headerValue && n.setRequestHeader(e.header, e.headerValue), e.requestedWith && n.setRequestHeader(
				"X-Requested-With", e.requestedWith), e.overrideMimeType && n.overrideMimeType(e.overrideMimeType), n.onload = t
			.onLoad.bind(t, n), n.onerror = t.onError.bind(t), n.onprogress = t.onProgress.bind(t), n.send(), setTimeout(
				function() {
					n.respond(200, {
	...
	function l() {
		a.call(this), this.readyState = l.UNSENT, this.requestHeaders = {}, this.requestBody = null, this.status = 0, this.statusText =
			"", this.upload = new a
	}
	a.prototype = {
		...
		dispatchEvent: function(t) {
			for (var e = t.type, n = this._eventListeners[e] || [], o = 0; o < n.length; o++) "function" == typeof n[o] ? n[
				o].call(this, t) : n[o].handleEvent(t);
	...
	var d = {
		...
		open: function(t, e, n, o, r) {
			this.method = t, this.url = e, this.async = "boolean" != typeof n || n, this.username = o, this.password = r,
				this.responseText = null, this.responseXML = null, this.responseURL = e, this.requestHeaders = {}, this.sendFlag = !
				1, this._readyStateChange(l.OPENED)
		},
		...
		send: function(t) {
			if (u(this), !/^(get|head)$/i.test(this.method)) {
				...
				}), e || (t || "").toString().match("FormData") || (this.requestHeaders["Content-Type"] =
					"text/plain;charset=UTF-8"), this.requestBody = t
			}
			this.errorFlag = !1, this.sendFlag = this.async, this._readyStateChange(l.OPENED), "function" == typeof this.onSend &&
				this.onSend(this), this.dispatchEvent(new o("loadstart", !1, !1, this))
		},
		abort: function() {
			this.aborted = !0, this.responseText = null, this.errorFlag = !0, this.requestHeaders = {}, this.dispatchEvent(
				new o("abort", !1, !1, this)), this.readyState > l.UNSENT && this.sendFlag && (this._readyStateChange(l.UNSENT),
		...
		getAllResponseHeaders: function() {
			...
			var t = "";
			for (var e in this.responseHeaders) this.responseHeaders.hasOwnProperty(e) && !/^Set-Cookie2?$/i.test(e) && (t +=
				e + ": " + this.responseHeaders[e] + "\r\n");
			return t
		},
		...
		_readyStateChange: function(t) {
			this.readyState = t, "function" == typeof this.onreadystatechange && this.onreadystatechange(new o(
				"readystatechange")), this.dispatchEvent(new o("readystatechange")), this.readyState == l.DONE && this.dispatchEvent(
				new o("load", !1, !1, this)), this.readyState != l.UNSENT && this.readyState != l.DONE || this.dispatchEvent(
				new o("loadend", !1, !1, this))
		},
		_setResponseHeaders: function(t) {
			for (var e in this.responseHeaders = {}, t) t.hasOwnProperty(e) && (this.responseHeaders[e] = t[e]);
			this.forceMimeType && (this.responseHeaders["Content-Type"] = this.forceMimeType), this.async ? this._readyStateChange(
				l.HEADERS_RECEIVED) : this.readyState = l.HEADERS_RECEIVED
		},
		_setResponseBody: function(t) {
			...
			if (this.responseText && (!i || /(text\/xml)|(application\/xml)|(\+xml)/.test(i))) try {
				this.responseXML = (o = this.responseText, "undefined" != typeof DOMParser ? r = (new DOMParser).parseFromString(
					o, "text/xml") : ((r = new ActiveXObject("Microsoft.XMLDOM")).async = "false", r.loadXML(o)), r)
			} catch (t) {}
			this.async ? this._readyStateChange(l.DONE) : this.readyState = l.DONE
		},
		respond: function(t, e, n) {
			this._setResponseHeaders(e || {}), this.status = "number" == typeof t ? t : 200, this.statusText = r[this.status],
